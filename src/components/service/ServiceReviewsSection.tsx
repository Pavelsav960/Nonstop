...
export default function ServiceReviewsSection({ service }: Props) {
  ...
  const ldJson = {
    ...
    review: reviews.map((r) => ({
      ...
      itemReviewed: {
        '@type': 'Service',
        name: service.name,
        provider: { '@type': 'LocalBusiness', '@id': `${BUSINESS.url}#localbusiness`, name: BUSINESS.name },
      },
    })),
  };

  return (
    <section className="section-ref bg-[#F5F5F5] overflow-hidden">
      ...
      <div className="container-ref">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h2 className="text-[#17171A] max-w-4xl mx-auto text-[26px] sm:text-[34px] md:text-[44px] lg:text-[52px]">
            <span className="whitespace-nowrap">5-Star Rated For</span>
            <br />
            {service.name}
          </h2>
          <a
              ...
              >
                ...
                <div className="flex items-start gap-3 pr-8">
                  {review.photo ? (
                    ...
                    <div className={`w-12 h-12 rounded-full ${avatarColors[index % avatarColors.length]} flex items-center justify-center text-white font-medium text-lg flex-shrink-0`}>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <span className="block text-[13px] text-[#70757a] normal-case mt-0.5">{formatDate(review.date)}</span>
                  </div>
                </div>
                <p
        ...
        <div className="mt-12 sm:mt-16 text-center max-w-2xl mx-auto">
          <h3 className="text-[#17171A] text-[20px] sm:text-[24px] lg:text-[28px] leading-[1.3] px-2">
            Need {service.name}?<br className="hidden sm:block" /> Call Now For A Free Service Estimate.
          </h3>
          <a
            ...
            aria-label={`Call ${BUSINESS.name} at ${BUSINESS.phone} for ${service.name}`}
          >
