...
export default function ContactServiceAreasSection() {
  return (
    <section className="section-ref bg-[#F5F5F5]" aria-labelledby="contact-areas-heading">
      <div className="container-ref">
        <div className="text-center mb-10 sm:mb-12">
          <p className="text-primary-600 text-[14px] sm:text-[16px] font-semibold tracking-wide normal-case mb-3">
            Service Areas
          </p>
          <h2 id="contact-areas-heading" className="text-[#17171A] max-w-4xl mx-auto px-2">
            {cityData.length} Cities Across St. Louis County
          </h2>
          <p className="mt-4 text-[16px] sm:text-[18px] text-gray-700 max-w-2xl mx-auto leading-relaxed px-4 font-medium">
            Not sure if we cover your area? Tap your city below to see local response times, pricing, and reviews.
          </p>
        </div>
