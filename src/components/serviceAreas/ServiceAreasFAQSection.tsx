...
const faqs = [
  {
    ...
    answer: `Yes. Our mobile fleet is positioned across St. Louis County so we can reach every city listed within our standard 15 to 30 minute window. Each city has its own dedicated page with local pricing details, response times, and reviews from real customers in that area.`,
  },
  {
    question: 'Are response times the same in every city?',
    answer: `Most cities see a 15 to 30 minute average arrival. A few outlying areas (Saint Charles, Town and Country) may add 5 to 10 minutes during peak hours or bad weather. We give you an honest ETA when you call so there are no surprises.`,
  },
  {
  ...
  },
  {
    ...
    answer: `For most jobs across St. Louis County, yes, usually within an hour. Emergency lockouts and lost keys are handled within 15 to 30 minutes. Larger installs (multiple lock replacements, smart lock installations) can usually be scheduled the same day if you call before noon.`,
  },
  {
