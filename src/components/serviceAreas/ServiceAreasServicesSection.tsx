...
export default function ServiceAreasServicesSection() {
  return (
    <section className="section-ref bg-white" aria-labelledby="areas-services-heading">
      <div className="container-ref">
        <div className="text-center mb-10 sm:mb-12">
          ...
          <h2 id="areas-services-heading" className="text-[#17171A] max-w-4xl mx-auto px-2">
            Every Locksmith Service We Offer
          </h2>
          <p className="mt-4 text-[16px] sm:text-[18px] text-gray-700 max-w-2xl mx-auto leading-relaxed px-4 font-medium">
            From quick car lockouts to full smart-lock installations — the same crew, same pricing, across every city we serve.
          </p>
        </div>
